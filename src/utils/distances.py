...
def inverse_difference_moment_matrix(N: int, M: int):
    ...
    # TODO: define the inverse difference momen
    raise Exception("Method is not implemented")
...
def seq_sinkhorn():
    ...
    Returns:
        torch.Tensor: The transportation matrix.
    """
    # TODO: implement the sequence sinkhorn algorithm
    raise Exception("Method is not implemented")
...
def get_mean_dist(source_embed, target_embed, source_attns, target_attns):
    ...
    # get the maximum values of the embeddings
    source_embed, _ = prep_relevant_embeds(source_embed, source_attns).mean(dim=1)
    target_embed, _ = prep_relevant_embeds(target_embed, target_attns).mean(dim=1)
    # return the cosine distance
    return __get_cosine_dist(source_embed, target_embed)
